...
static const struct extended_command gatt_client_commands[] = {
		...
		{{ "read_characteristic",			"<conn_id> <16bit_UUID | 128bit_UUID> <is_primary> <inst_id> <16bit_UUID | 128bit_UUID> <inst_id> <auth_req>", run_gatt_client_read_characteristic}, 8, 8},
		{{ "write_characteristic",			"<conn_id> <16bit_UUID | 128bit_UUID> <is_primary> <inst_id> <16bit_UUID | 128bit_UUID> <inst_id> <write_type> <auth_req> <hex_value>", run_gatt_client_write_characteristic}, 10, 10},
		{{ "read_descriptor",				"<conn_id> <16bit_UUID | 128bit_UUID> <is_primary> <inst_id> <16bit_UUID | 128bit_UUID> <inst_id> <16bit_UUID | 128bit_UUID> <inst_id> <auth_req>", run_gatt_client_read_descriptor}, 10, 10},
